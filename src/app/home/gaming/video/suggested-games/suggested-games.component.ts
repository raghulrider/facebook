...
@Component({
  selector: 'app-suggested-games',
  templateUrl: './suggested-games.component.html',
  styleUrls: ['./suggested-games.component.css']
})
export class SuggestedGamesComponent implements OnInit {
